...
#define SET_PWM2_PHASE_CORRECT_MODE() TCCR2_bits._WGM20=1;TCCR2_bits._WGM21=0
			   
#define SET_PWM2_INVERTED_MODE() TCCR2_bits._COM2=3
#define SET_PWM2_NON_INVERTED_MODE() TCCR2_bits._COM2=2

#define PWM2_SET_PRESCALER_1()    (TCCR2_bits._CS2=1)
#define PWM2_SET_PRESCALER_8()    (TCCR2_bits._CS2=2)
#define PWM2_SET_PRESCALER_32()   (TCCR2_bits._CS2=3)
#define PWM2_SET_PRESCALER_64()   (TCCR2_bits._CS2=3)
#define PWM2_SET_PRESCALER_128()   (TCCR2_bits._CS2=3)
#define PWM2_SET_PRESCALER_256()  (TCCR2_bits._CS2=6)
#define PWM2_SET_PRESCALER_1024() (TCCR2_bits._CS2=7)

#define SET_PWM1_FAST_MODE() TCCR1_bits.WGM13=1;TCCR1_bits.WGM12=1;TCCR1_bits.WGM11=1;TCCR1_bits.WGM10=1
#define SET_PWM1_PHASE_CORRECT_MODE() TCCR1_bits.WGM13=1;TCCR1_bits.WGM12=0;TCCR1_bits.WGM11=1;TCCR1_bits.WGM10=1

#define SET_PWM1_INVERTED_MODE() TCCR1_bits.COM1B=3
#define SET_PWM1_NON_INVERTED_MODE() TCCR1_bits.COM1B=2
